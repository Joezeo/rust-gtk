...
impl ObjectSubclass for WidgetTitleBar {
    ...
    fn class_init(klass: &mut Self::Class) {
        ...
        // Make it appear as a toobar to accessibility tools.
        klass.set_accessible_role(gtk::AccessibleRole::Toolbar);
    }
}
...
impl ObjectImpl for WidgetTitleBar {
    fn constructed(&self) {
        ...
        let label = Label::builder()
            ...
            .margin_end(5)
            .build();
        label.set_markup("<span font_desc=\"Consolas\"><b>Hello Wrold</b></span>");
